...
for/*TODO:refactor each()*/ each($a_alle_mitarbeiter as $id => $a_mitarbeiter){
	echo $id . ' : ' . $a_mitarbeiter['wp_mitarbeiter_name'] .', '.$a_mitarbeiter['wp_mitarbeiter_vorname'] . ' - ' . $a_mitarbeiter['wp_mitarbeiter_kategorie'] . ' ('.$a_mitarbeiter['wp_mitarbeiter_funktion'].')<br />';
}
*/
?>
