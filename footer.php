      ...
      <div class="mx-auto">
        ...
        ?>
          ...
          <div class="flex gap-3 mt-4">
            ...
            <a href="#" class="inline-flex items-center justify-center w-10 h-10 border border-[#1A1A1A] rounded" aria-label="Instagram" title="Instagram">
            ...
            <a href="#" class="inline-flex items-center justify-center w-10 h-10 border border-[#1A1A1A] rounded" aria-label="YouTube" title="YouTube">
